...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.com.example.android.sunshine.app.ACTION_DATA_UPDATED";
    ...
    private void sendData(double max , double min, int id){
//        Random rn = new Random();
//        int i = rn.nextInt();
        Log.d("Zegarek - app", "wysyłam dane : " + max);
        int maxInt = (int) max;
        int minInt = (int) min;
        PutDataMapRequest putDataMapReq = PutDataMapRequest.create("/max_sunshine_temp");
        putDataMapReq.getDataMap().putString("max", String.valueOf(id) + " " + maxInt + " " + minInt);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, putDataReq)
            ...
            public void onResult(DataApi.DataItemResult dataItemResult) {
                Log.d("Zegarek", "Sending was successful: " + dataItemResult.getStatus()
                        .isSuccess());
            }
        });
    }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                updateMuzei();
                notifyWeather();
                sendData(todayHigh, todayLow, todayID);
            }
